...
class ControllerExtensionPaymentNochex extends Controller {
	public function index() {
		...
		$data['description'] = /*$this->config->get('config_name')*/ $description;  
		...
		$data['xml_item_collection']= $xmlCollection;
	...
	public function callback() {
		...
		$curl = curl_init('https://www.nochex.com/apcnet/apc.aspx');
		...
		if (strcmp($response, 'AUTHORISED') == 0) {					
			$Msg = "APC was " . $response. ", and this was a " . $_POST['status'] . " transaction.";						
